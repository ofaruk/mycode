...
with models.DAG(
    ...
    load_base_csv = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        task_id='load_base',
        bucket='jlr-test-files',  # gcs_bucket_name,
        source_objects=csv_base_dataset,  # ['Base_dataset.csv'],  #
    ...
    load_options_csv = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
        ...
        source_objects=csv_options_dataset,
        destination_project_dataset_table=bq_options_table_name,
        skip_leading_rows=1,
        allow_quoted_newlines=True,
